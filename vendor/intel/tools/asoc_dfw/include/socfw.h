...
#define snd_soc_info_bytes_ext		SOC_CONTROL_TYPE_BYTES_EXT
...
struct snd_soc_dapm_widget {
	...
	unsigned short event_type;	/* Event type to map event handler */
	unsigned short event_flags;	/* flags to specify event types */
	unsigned int pvt_data_len;	/* Length of pvt_data */
