...
status_t layer_state_t::write(Parcel& output) const
{
    ...
    output.writeInt32(projectorable);
    output.writeInt32(projected_main);
#endif
...
status_t layer_state_t::read(const Parcel& input)
{
    ...
    /* BLADEIII, liujk2, add for dlp extension mode, begin @{ */
#ifdef DLP_FEATURE_EXTENSION_MODE
    projectorable = static_cast<uint8_t>(input.readInt32());
    projected_main = static_cast<uint8_t>(input.readInt32());
#endif
    /* BLADEIII, liujk2, add for dlp extension mode, end @} */
