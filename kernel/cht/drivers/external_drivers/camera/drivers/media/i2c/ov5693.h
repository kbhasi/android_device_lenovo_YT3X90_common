...
/*
------------------------------------
@@ FULL QSXGA (2592x1944) 30fps 33.33ms VBlank 2lane 10Bit
100 99 2592 1944
100 98 1 0
...
static struct ov5693_reg const ov5693_1080p_30fps[] = {
	...
	{OV5693_8BIT, 0x3804, 0x0a},	/* x_addr_end: 2623 */
	{OV5693_8BIT, 0x3805, 0x3f},
	{OV5693_8BIT, 0x3806, 0x06},	/* y_addr_end: 1715 */
...
static struct ov5693_reg const ov5693_480p_30fps[] = {
	...
	{OV5693_8BIT, 0x3800, 0x00},	/* x_addr_start: 0 */
	{OV5693_8BIT, 0x3801, 0x00},
	{OV5693_8BIT, 0x3802, 0x00},	/* y_addr_start: 104 */
	{OV5693_8BIT, 0x3803, 0x68},
	{OV5693_8BIT, 0x3804, 0x0a},	/* x_addr_end: 2623 */
	{OV5693_8BIT, 0x3805, 0x3f},
	{OV5693_8BIT, 0x3806, 0x07},	/* y_addr_end: 1851 */
...
static int ov5693_write_reg(struct i2c_client *client, u16 data_length,	u16 reg, u16 val);
static int ov5693_read_reg(struct i2c_client *client, u16 data_length, u16 reg, u16 *val);
#endif
