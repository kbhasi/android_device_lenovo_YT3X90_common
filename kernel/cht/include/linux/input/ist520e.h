 ...
 * board porting :
 *-----------------------------------------------------------------------------*/
#define ISTCORE_DEV_NAME            "IST_CRIMSON : "
...
#define IST_ANYPEN_SWITCH		(0x081D)

#define DO_STARTUP_FW_UPDATE
#define FWUPDATE_WORK_DELAY_MS 10000
#define OFM_IST940E_FW      "hideep/Lenovo_Blade3_MP_01000025_20160108.bin"
#define GIS_IST940E_FW      "hideep/Lenovo_Blade3_PVT3_06000016_20150910.bin"
#define KEY_LPM_WAKEUP	KEY_WAKEUP
#define HIDEEP_LPM
#define HIDEEP_DD_VERSION_MAJOR	0
#define HIDEEP_DD_VERSION_MINOR 3
//#define HIDEEP_DD_DISCRIPTION	"20150825 modify the selftest function and set the data base. v3"
//#define HIDEEP_DD_DISCRIPTION	"20150828 modify the reset function, remove baseline reset."
#define HIDEEP_DD_DISCRIPTION	"20150831 add the LCD on/off reset function."
/*------------------------------------------------------------------------------
 *
 *-----------------------------------------------------------------------------*/
...
void istcore_lcd_on_reset_ic(void);
