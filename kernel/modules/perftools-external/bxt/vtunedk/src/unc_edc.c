...
)
{
    UNC_COMMON_PCI_Write_PMU(param, 
                             ...
                             RESET_EDC_CTRS,
                             UNCORE_TOPOLOGY_INFO_NODE_EDC_UCLK,
...
{
    UNC_COMMON_PCI_Scan_For_Uncore(param, UNCORE_TOPOLOGY_INFO_NODE_EDC_UCLK, &unc_edc_uclk_knl_callback);
}
...
)
{
    UNC_COMMON_PCI_Write_PMU(param, 
                             ...
                             KNL_UBOX_GLOBAL_CONTROL_MSR, 
                             RESET_EDC_CTRS,
                             UNCORE_TOPOLOGY_INFO_NODE_EDC_ECLK,
...
{
    UNC_COMMON_PCI_Scan_For_Uncore(param, UNCORE_TOPOLOGY_INFO_NODE_EDC_ECLK, &unc_edc_eclk_knl_callback);
}
