...
struct DISPATCH_NODE_S {
    ...
    VOID (*trigger_read)(U32);    // Counter reads triggered/initiated by User mode timer
...
struct LWPMU_DEVICE_NODE_S {
    ...
    VOID       *pcfg_unc;
    U64        **unc_to_read_data;
    U64        **unc_current_data;
    U64        **unc_prev_value;
    U64        ***unc_acc_value;
    U64        **acc_per_thread;
...
#define LWPMU_DEVICE_to_read_data(dev)        (dev)->unc_to_read_data
#define LWPMU_DEVICE_current_data(dev)        (dev)->unc_current_data
