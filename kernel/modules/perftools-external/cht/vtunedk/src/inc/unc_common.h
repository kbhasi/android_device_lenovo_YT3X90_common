...
typedef struct CALLBACK_NODE_LIN_S     CALLBACK_NODE_LIN;
typedef        CALLBACK_NODE_LIN      *CALLBACK_LIN;

struct CALLBACK_NODE_LIN_S {
    VOID     (*init_Device_IDs)(void);
    U32*     (*get_Device_IDs)(U32 *);
    DRV_BOOL (*is_Unit_Ctl)(U32);
    DRV_BOOL (*is_PMON_Ctl)(U32);
};
