...
static U32            imc_dids[MAX_PCI_DEVS];
...
static VOID
unc_imc_uclk_knl_init_Device_IDs(
    void
)
{
    imc_dids[0] = KNL_IMC_UCLK_DID;
}

static U32*
unc_imc_uclk_knl_get_Device_IDs(
    U32 *num_devs
)
{
    *num_devs = KNL_IMC_NUM_DEVS;
    return &imc_dids[0];
}
...
CALLBACK_NODE_LIN  unc_imc_uclk_knl_callback_lin = {
    unc_imc_uclk_knl_init_Device_IDs,
    unc_imc_uclk_knl_get_Device_IDs,
    unc_imc_uclk_knl_is_Unit_Ctl,
    unc_imc_uclk_knl_is_PMON_Ctl
...
{
    UNC_COMMON_PCI_Lin_Scan_For_Uncore(param, UNCORE_TOPOLOGY_INFO_NODE_IMC_UCLK, &unc_imc_uclk_knl_callback_lin);
}
...
static VOID
unc_imc_chx_knl_init_Device_IDs(
    void
)
{
    imc_dids[0] = KNL_IMC_CHX_DID;
}

static U32*
unc_imc_chx_knl_get_Device_IDs(
    U32 *num_devs
)
{
    *num_devs = KNL_IMC_NUM_DEVS;
...
CALLBACK_NODE_LIN  unc_imc_chx_knl_callback_lin = {
    unc_imc_chx_knl_init_Device_IDs,
    unc_imc_chx_knl_get_Device_IDs,
    unc_imc_chx_knl_is_Unit_Ctl,
    unc_imc_chx_knl_is_PMON_Ctl
...
{
    UNC_COMMON_PCI_Lin_Scan_For_Uncore(param, UNCORE_TOPOLOGY_INFO_NODE_IMC, &unc_imc_chx_knl_callback_lin);
}
