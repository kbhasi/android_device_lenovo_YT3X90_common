...
#define LWPMUDRV_IOCTL_COMPAT_GET_MARKER_ID          _IOW(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_MARKER_ID, compat_uptr_t)
#endif
...
#define LWPMUDRV_IOCTL_GET_MARKER_ID          _IOW(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_MARKER_ID, IOCTL_ARGS)
